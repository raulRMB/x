...
namespace x {
    ...
    x::RenderUtil::QueueFamilyIndices rendererDevice::GetQueueFamilies(VkPhysicalDevice device) {
    ...
    x::RenderUtil::SurfaceDetails rendererDevice::GetSurfaceDetails(VkPhysicalDevice device)
    {
        x::RenderUtil::SurfaceDetails SurfaceDetails;
    ...
    void rendererDevice::CreateLogicalDevice(VkInstance Instance) {
