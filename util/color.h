...
namespace X::Color
{
    ...
    glm::vec4 Magenta = glm::vec4(1.0f, 0.0f, 1.0f, 1.0f);
    glm::vec4 Gray = glm::vec4(0.5f, 0.5f, 0.5f, 1.0f);
    glm::vec4 LightGray = glm::vec4(0.75f, 0.75f, 0.75f, 1.0f);
    glm::vec4 DarkGray = glm::vec4(0.25f, 0.25f, 0.25f, 1.0f);
    glm::vec4 Orange = glm::vec4(1.0f, 0.5f, 0.0f, 1.0f);
    glm::vec4 Brown = glm::vec4(0.5f, 0.25f, 0.0f, 1.0f);
