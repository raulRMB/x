...
#include "SwapChain.h"
    ...
    void SwapChain::Clean(Device MainDevice) 
    {
    ...
    void SwapChain::Create(Device MainDevice, SurfaceDetails surfaceDetails, QueueFamilyIndices indices)
    {
        ...
        for(VkImage image : images)
        {
            ...
            swapChainImage.ImageView = CreateImageView(image, SwapchainImageFormat, VK_IMAGE_ASPECT_COLOR_BIT, MainDevice.LogicalDevice);
