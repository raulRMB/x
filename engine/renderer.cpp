...
{
    std::vector<char> vertShaderCode = xUtil::xFile::ReadAsBin("../shaders/skeletalVert.spv");
    std::vector<char> fragShaderCode = xUtil::xFile::ReadAsBin("../shaders/skeletalFrag.spv");
